...
const baseLootableCardDefinitions: CardDefinition[] = [
  ...
  },
  {
    ...
    inkedVariant: {
      description: "Deal 8 damage. Apply 7 Poison.",
      effects: [
        { type: "DAMAGE", value: 8 },
        { type: "APPLY_DEBUFF", value: 7, buff: "POISON" },
      ],
      inkMarkCost: 2,
    },
    upgrade: {
      description: "Deal 7 damage. Apply 7 Poison.",
      effects: [
        { type: "DAMAGE", value: 7 },
        { type: "APPLY_DEBUFF", value: 7, buff: "POISON" },
      ],
  ...
  },
  {
    ...
    inkedVariant: {
      description: "Gain 5 ink.",
      effects: [{ type: "GAIN_INK", value: 5 }],
      inkMarkCost: 1,
    },
    upgrade: {
  ...
  // =========================================================
  {
    ...
    targeting: "SELF",
    rarity: "RARE",
    description: "Gain 2 Strength. Gain 1 ink.",
    effects: [
      { type: "GAIN_STRENGTH", value: 2 },
      { type: "GAIN_INK", value: 1 },
    ],
    inkedVariant: {
      description: "Gain 3 Strength. Gain 1 ink.",
      effects: [
        { type: "GAIN_STRENGTH", value: 3 },
        { type: "GAIN_INK", value: 1 },
      ],
      inkMarkCost: 2,
      upgradedDescription: "Gain 3 Strength. Gain 1 ink.",
      upgradedEffects: [
        { type: "GAIN_STRENGTH", value: 3 },
        { type: "GAIN_INK", value: 1 },
      ],
  ...
  },
  {
    ...
    targeting: "SINGLE_ENEMY",
    rarity: "UNCOMMON",
    description: "Deal 10 damage. Apply 5 Poison.",
    effects: [
...

  {
    ...
    targeting: "SINGLE_ENEMY",
    rarity: "UNCOMMON",
    description: "Deal 13 damage. Apply 3 Bleed.",
    effects: [
      { type: "DAMAGE", value: 13 },
      { type: "APPLY_DEBUFF", value: 3, buff: "BLEED", duration: 4 },
    ],
    inkedVariant: {
      description: "Deal 17 damage. Apply 4 Bleed.",
      effects: [
  ...
  },
  {
    ...
    rarity: "UNCOMMON",
    description:
      "Deal 5 damage to ALL enemies. Apply 1 Vulnerable to ALL. Draw 1 card.",
    effects: [
      { type: "DAMAGE", value: 5 },
      { type: "APPLY_DEBUFF", value: 1, buff: "VULNERABLE", duration: 2 },
      { type: "DRAW_CARDS", value: 1 },
  ...
  },
  {
    ...
    inkedVariant: null,
    upgrade: {
      description: "Deal 8 damage to ALL enemies. Apply 4 Poison to ALL.",
      effects: [
        { type: "DAMAGE", value: 8 },
  ...
  },
  {
    ...
    targeting: "SINGLE_ENEMY",
    rarity: "UNCOMMON",
    description: "Deal 5 damage. Apply 5 Poison. Gain 1 ink.",
    effects: [
      { type: "DAMAGE", value: 5 },
      { type: "APPLY_DEBUFF", value: 5, buff: "POISON" },
      { type: "GAIN_INK", value: 1 },
    ...
    inkedVariant: {
      description: "Deal 7 damage. Apply 7 Poison. Gain 2 ink.",
      effects: [
        { type: "DAMAGE", value: 7 },
        { type: "APPLY_DEBUFF", value: 7, buff: "POISON" },
        { type: "GAIN_INK", value: 2 },
    ...
    upgrade: {
      description: "Deal 7 damage. Apply 7 Poison. Gain 1 ink.",
      effects: [
        { type: "DAMAGE", value: 7 },
        { type: "APPLY_DEBUFF", value: 7, buff: "POISON" },
        { type: "GAIN_INK", value: 1 },
  ...
  },
  {
    ...
    targeting: "SELF",
    rarity: "UNCOMMON",
    description: "Gain 3 Ink. Draw 1 card. Exhaust.",
    effects: [
      { type: "GAIN_INK", value: 3 },
      { type: "DRAW_CARDS", value: 1 },
      { type: "EXHAUST", value: 0 },
...

  {
    ...
    inkedVariant: {
      description: "Deal 11 damage. Apply 5 Bleed. Gain 2 Strength.",
      effects: [
        { type: "DAMAGE", value: 11 },
        { type: "APPLY_DEBUFF", value: 5, buff: "BLEED", duration: 4 },
        { type: "GAIN_STRENGTH", value: 2 },
      ],
      inkMarkCost: 2,
    },
    upgrade: {
      description: "Deal 11 damage. Apply 5 Bleed. Gain 1 Strength.",
      effects: [
        { type: "DAMAGE", value: 11 },
        { type: "APPLY_DEBUFF", value: 5, buff: "BLEED", duration: 4 },
        { type: "GAIN_STRENGTH", value: 1 },
  ...
  // =========================================================
  {
    ...
    inkedVariant: {
      description: "Deal 9 damage. Apply 5 Poison. Heal 4.",
      effects: [
        { type: "DAMAGE", value: 9 },
        { type: "APPLY_DEBUFF", value: 5, buff: "POISON" },
        { type: "HEAL", value: 4 },
    ...
    upgrade: {
      description: "Deal 9 damage. Apply 4 Poison. Heal 2.",
      effects: [
        { type: "DAMAGE", value: 9 },
        { type: "APPLY_DEBUFF", value: 4, buff: "POISON" },
        { type: "HEAL", value: 2 },
  ...
  },
  {
    ...
    targeting: "SELF",
    rarity: "RARE",
    description: "Gain 1 Strength and 1 Focus. Gain 1 ink.",
    effects: [
      { type: "GAIN_STRENGTH", value: 1 },
    ...
    inkedVariant: {
      description: "Gain 2 Strength and 1 Focus. Gain 1 ink.",
      effects: [
        { type: "GAIN_STRENGTH", value: 2 },
        { type: "GAIN_FOCUS", value: 1 },
        { type: "GAIN_INK", value: 1 },
      ...
      inkMarkCost: 3,
      upgradedDescription: "Gain 3 Strength and 2 Focus. Gain 1 ink.",
      upgradedEffects: [
        { type: "GAIN_STRENGTH", value: 3 },
        { type: "GAIN_FOCUS", value: 2 },
        { type: "GAIN_INK", value: 1 },
    ...
    upgrade: {
      description: "Gain 2 Strength and 2 Focus. Gain 1 ink.",
      effects: [
        { type: "GAIN_STRENGTH", value: 2 },
        { type: "GAIN_FOCUS", value: 2 },
        { type: "GAIN_INK", value: 1 },
...

  {
    ...
    targeting: "ALL_ENEMIES",
    rarity: "COMMON",
    description: "Deal 2 damage to ALL enemies. Apply 3 Poison to ALL.",
    effects: [
      { type: "DAMAGE", value: 2 },
      { type: "APPLY_DEBUFF", value: 3, buff: "POISON" },
    ],
    inkedVariant: {
      description: "Deal 3 damage to ALL enemies. Apply 5 Poison to ALL.",
      effects: [
        { type: "DAMAGE", value: 3 },
        { type: "APPLY_DEBUFF", value: 5, buff: "POISON" },
      ],
    ...
    upgrade: {
      description: "Deal 2 damage to ALL enemies. Apply 4 Poison to ALL.",
      effects: [
        { type: "DAMAGE", value: 2 },
        { type: "APPLY_DEBUFF", value: 4, buff: "POISON" },
      ],
  ...
  },
  {
    ...
    targeting: "ALL_ENEMIES",
    rarity: "COMMON",
    description: "Gain 8 block. Apply 3 Poison to ALL enemies.",
    effects: [
      { type: "BLOCK", value: 8 },
      { type: "APPLY_DEBUFF", value: 3, buff: "POISON" },
    ],
    inkedVariant: null,
    upgrade: {
      description: "Gain 12 block. Apply 4 Poison to ALL enemies.",
      effects: [
        { type: "BLOCK", value: 12 },
        { type: "APPLY_DEBUFF", value: 4, buff: "POISON" },
      ],
  ...
  },
  {
    ...
    targeting: "SELF",
    rarity: "RARE",
    description: "Gain 1 Strength. Draw 1 card. Gain 1 ink.",
    effects: [
      { type: "GAIN_STRENGTH", value: 1 },
      { type: "DRAW_CARDS", value: 1 },
      { type: "GAIN_INK", value: 1 },
    ...
    inkedVariant: null,
    upgrade: {
      description: "Gain 2 Strength. Draw 2 cards. Gain 1 ink.",
      effects: [
        { type: "GAIN_STRENGTH", value: 2 },
        { type: "DRAW_CARDS", value: 2 },
        { type: "GAIN_INK", value: 1 },
  ...
  // =========================================================
  {
    ...
    inkedVariant: {
      description: "Apply 3 Bleed. Deal 4 damage per Bleed on target.",
      effects: [
        { type: "APPLY_DEBUFF", value: 3, buff: "BLEED", duration: 4 },
        { type: "DAMAGE_PER_DEBUFF", value: 4, buff: "BLEED" },
      ],
  ...
  },
  {
    ...
    inkedVariant: {
      description: "Draw 1 card. Gain 3 Strength. Apply 4 Bleed.",
      effects: [
        { type: "DRAW_CARDS", value: 1 },
        { type: "GAIN_STRENGTH", value: 3 },
        { type: "APPLY_DEBUFF", value: 4, buff: "BLEED", duration: 4 },
      ...
      inkMarkCost: 2,
      upgradedDescription: "Draw 1 card. Gain 3 Strength. Apply 5 Bleed.",
      upgradedEffects: [
        { type: "DRAW_CARDS", value: 1 },
        { type: "GAIN_STRENGTH", value: 3 },
        { type: "APPLY_DEBUFF", value: 5, buff: "BLEED", duration: 4 },
    ...
    upgrade: {
      description: "Draw 1 card. Gain 2 Strength. Apply 4 Bleed.",
      effects: [
        { type: "DRAW_CARDS", value: 1 },
        { type: "GAIN_STRENGTH", value: 2 },
        { type: "APPLY_DEBUFF", value: 4, buff: "BLEED", duration: 4 },
  ...
  },
  {
    ...
    targeting: "ALL_ENEMIES",
    rarity: "UNCOMMON",
    description: "Deal 10 damage to ALL enemies. Apply 3 Bleed to ALL enemies.",
    effects: [
      { type: "DAMAGE", value: 10 },
      { type: "APPLY_DEBUFF", value: 3, buff: "BLEED", duration: 4 },
    ],
    inkedVariant: {
      description:
        "Deal 14 damage to ALL enemies. Apply 4 Bleed to ALL enemies.",
      effects: [
        { type: "DAMAGE", value: 14 },
        { type: "APPLY_DEBUFF", value: 4, buff: "BLEED", duration: 4 },
      ],
  ...
  },
  {
    ...
    inkedVariant: {
      description: "Gain 3 ink. Apply 4 Poison. Draw 1 card.",
      effects: [
        { type: "GAIN_INK", value: 3 },
        { type: "APPLY_DEBUFF", value: 4, buff: "POISON" },
        { type: "DRAW_CARDS", value: 1 },
    ...
    upgrade: {
      description: "Gain 2 ink. Apply 4 Poison. Draw 1 card.",
      effects: [
        { type: "GAIN_INK", value: 2 },
        { type: "APPLY_DEBUFF", value: 4, buff: "POISON" },
        { type: "DRAW_CARDS", value: 1 },
  ...
  },
  {
    ...
    targeting: "SINGLE_ENEMY",
    rarity: "UNCOMMON",
    description: "Deal 11 damage. Apply 4 Poison. Gain 2 ink.",
    effects: [
      { type: "DAMAGE", value: 11 },
      { type: "APPLY_DEBUFF", value: 4, buff: "POISON" },
      { type: "GAIN_INK", value: 2 },
    ...
    inkedVariant: {
      description: "Deal 15 damage. Apply 5 Poison. Gain 3 ink.",
      effects: [
    ...
    upgrade: {
      description: "Deal 15 damage. Apply 4 Poison. Gain 2 ink.",
      effects: [
        { type: "DAMAGE", value: 15 },
        { type: "APPLY_DEBUFF", value: 4, buff: "POISON" },
        { type: "GAIN_INK", value: 2 },
  ...
  },
  {
    ...
    targeting: "SINGLE_ENEMY",
    rarity: "UNCOMMON",
    description: "Deal 14 damage. Apply 3 Bleed. Apply 1 Weak.",
    effects: [
      { type: "DAMAGE", value: 14 },
      { type: "APPLY_DEBUFF", value: 3, buff: "BLEED", duration: 4 },
      { type: "APPLY_DEBUFF", value: 1, buff: "WEAK", duration: 2 },
    ...
    inkedVariant: {
      description: "Deal 18 damage. Apply 4 Bleed. Apply 2 Weak.",
      effects: [
        { type: "DAMAGE", value: 18 },
        { type: "APPLY_DEBUFF", value: 4, buff: "BLEED", duration: 4 },
        { type: "APPLY_DEBUFF", value: 2, buff: "WEAK", duration: 2 },
    ...
    upgrade: {
      description: "Deal 18 damage. Apply 3 Bleed. Apply 1 Weak.",
      effects: [
        { type: "DAMAGE", value: 18 },
        { type: "APPLY_DEBUFF", value: 3, buff: "BLEED", duration: 4 },
        { type: "APPLY_DEBUFF", value: 1, buff: "WEAK", duration: 2 },
  ...
  },
  {
    ...
    targeting: "ALL_ENEMIES",
    rarity: "UNCOMMON",
    description: "Deal 7 damage to ALL enemies. Apply 3 Bleed to ALL enemies.",
    effects: [
      { type: "DAMAGE", value: 7 },
      { type: "APPLY_DEBUFF", value: 3, buff: "BLEED", duration: 4 },
    ],
    inkedVariant: {
      description:
        "Deal 9 damage to ALL enemies. Apply 4 Bleed to ALL enemies.",
      effects: [
        { type: "DAMAGE", value: 9 },
        { type: "APPLY_DEBUFF", value: 4, buff: "BLEED", duration: 4 },
      ],
    ...
    upgrade: {
      description:
        "Deal 9 damage to ALL enemies. Apply 3 Bleed to ALL enemies.",
      effects: [
        { type: "DAMAGE", value: 9 },
        { type: "APPLY_DEBUFF", value: 3, buff: "BLEED", duration: 4 },
      ],
  ...
  // =========================================================
  {
    ...
    targeting: "SINGLE_ENEMY",
    rarity: "COMMON",
    description: "Gain 3 ink. Deal 6 damage to target.",
    effects: [
      { type: "GAIN_INK", value: 3 },
      { type: "DAMAGE", value: 6 },
    ],
    inkedVariant: {
      description: "Gain 4 ink. Deal 9 damage to target.",
      effects: [
        { type: "GAIN_INK", value: 4 },
        { type: "DAMAGE", value: 9 },
      ],
    ...
    upgrade: {
      description: "Gain 4 ink. Deal 7 damage to target.",
      effects: [
        { type: "GAIN_INK", value: 4 },
        { type: "DAMAGE", value: 7 },
      ],
  ...
  // =========================================================
  {
    ...
    targeting: "SINGLE_ENEMY",
    rarity: "COMMON",
    description: "Deal 7 damage. Apply 3 Poison. Draw 1 card.",
    effects: [
      { type: "DAMAGE", value: 7 },
      { type: "APPLY_DEBUFF", value: 3, buff: "POISON" },
      { type: "DRAW_CARDS", value: 1 },
    ...
    inkedVariant: {
      description: "Deal 10 damage. Apply 4 Poison. Draw 1 card.",
      effects: [
        { type: "DAMAGE", value: 10 },
        { type: "APPLY_DEBUFF", value: 4, buff: "POISON" },
        { type: "DRAW_CARDS", value: 1 },
    ...
    upgrade: {
      description: "Deal 9 damage. Apply 3 Poison. Draw 1 card.",
      effects: [
        { type: "DAMAGE", value: 9 },
        { type: "APPLY_DEBUFF", value: 3, buff: "POISON" },
        { type: "DRAW_CARDS", value: 1 },
  ...
  },
  {
    ...
    targeting: "SINGLE_ENEMY",
    rarity: "COMMON",
    description: "Gain 2 ink. Draw 1 card. Apply 3 Poison.",
    effects: [
      { type: "GAIN_INK", value: 2 },
      { type: "DRAW_CARDS", value: 1 },
      { type: "APPLY_DEBUFF", value: 3, buff: "POISON" },
    ...
    inkedVariant: null,
    upgrade: {
      description: "Gain 3 ink. Draw 1 card. Apply 4 Poison.",
      effects: [
        { type: "GAIN_INK", value: 3 },
        { type: "DRAW_CARDS", value: 1 },
        { type: "APPLY_DEBUFF", value: 4, buff: "POISON" },
  ...
  },
  {
    ...
    inkedVariant: {
      description: "Gain 4 ink. Draw 2 cards. Gain 2 Strength.",
      effects: [
        { type: "GAIN_INK", value: 4 },
        { type: "DRAW_CARDS", value: 2 },
        { type: "GAIN_STRENGTH", value: 2 },
